    ...
    public List<Build> BuildsData {
      get {
        return mBuilds.Select(B => new Build {
          ...
          Champion = mChampions.Where(CH => B["champion"].ToString() == CH.ID).Select(CH => CH.Name).First()
        }).ToList();
      }
    }
    ...
    public List<RunePage> RunePagesData {
      get {
        return mRunePages.Select(RP => new RunePage {
          ...
          Mark1 = mMarks.Where(I => RP["mark1"].ToString() == I.ID).First(),
          Mark2 = mMarks.Where(I => RP["mark2"].ToString() == I.ID).First(),
          Mark3 = mMarks.Where(I => RP["mark3"].ToString() == I.ID).First(),
          Mark4 = mMarks.Where(I => RP["mark4"].ToString() == I.ID).First(),
          Mark5 = mMarks.Where(I => RP["mark5"].ToString() == I.ID).First(),
          Mark6 = mMarks.Where(I => RP["mark6"].ToString() == I.ID).First(),
          Mark7 = mMarks.Where(I => RP["mark7"].ToString() == I.ID).First(),
          Mark8 = mMarks.Where(I => RP["mark8"].ToString() == I.ID).First(),
          Mark9 = mMarks.Where(I => RP["mark9"].ToString() == I.ID).First(),
          Seal1 = mSeals.Where(I => RP["seal1"].ToString() == I.ID).First(),
          Seal2 = mSeals.Where(I => RP["seal2"].ToString() == I.ID).First(),
          Seal3 = mSeals.Where(I => RP["seal3"].ToString() == I.ID).First(),
          Seal4 = mSeals.Where(I => RP["seal4"].ToString() == I.ID).First(),
          Seal5 = mSeals.Where(I => RP["seal5"].ToString() == I.ID).First(),
          Seal6 = mSeals.Where(I => RP["seal6"].ToString() == I.ID).First(),
          Seal7 = mSeals.Where(I => RP["seal7"].ToString() == I.ID).First(),
          Seal8 = mSeals.Where(I => RP["seal8"].ToString() == I.ID).First(),
          Seal9 = mSeals.Where(I => RP["seal9"].ToString() == I.ID).First(),
          Glyph1 = mGlyphs.Where(I => RP["glyph1"].ToString() == I.ID).First(),
          Glyph2 = mGlyphs.Where(I => RP["glyph2"].ToString() == I.ID).First(),
          Glyph3 = mGlyphs.Where(I => RP["glyph3"].ToString() == I.ID).First(),
          Glyph4 = mGlyphs.Where(I => RP["glyph4"].ToString() == I.ID).First(),
          Glyph5 = mGlyphs.Where(I => RP["glyph5"].ToString() == I.ID).First(),
          Glyph6 = mGlyphs.Where(I => RP["glyph6"].ToString() == I.ID).First(),
          Glyph7 = mGlyphs.Where(I => RP["glyph7"].ToString() == I.ID).First(),
          Glyph8 = mGlyphs.Where(I => RP["glyph8"].ToString() == I.ID).First(),
          Glyph9 = mGlyphs.Where(I => RP["glyph9"].ToString() == I.ID).First(),
          Quint1 = mQuints.Where(I => RP["quint1"].ToString() == I.ID).First(),
          Quint2 = mQuints.Where(I => RP["quint1"].ToString() == I.ID).First(),
          Quint3 = mQuints.Where(I => RP["quint1"].ToString() == I.ID).First()
        }).ToList();
      }
    }
    ...
    public List<ItemSet> ItemSetsData {
      get {
        return mItemSets.Select(IS => new ItemSet {
          ...
          Item1 = mItems.Where(I => IS["item1"].ToString() == I.ID).First(),
          Item2 = mItems.Where(I => IS["item2"].ToString() == I.ID).First(),
          Item3 = mItems.Where(I => IS["item3"].ToString() == I.ID).First(),
          Item4 = mItems.Where(I => IS["item4"].ToString() == I.ID).First(),
          Item5 = mItems.Where(I => IS["item5"].ToString() == I.ID).First(),
          Item6 = mItems.Where(I => IS["item6"].ToString() == I.ID).First(),
          Item7 = mItems.Where(I => IS["item7"].ToString() == I.ID).First(),
          Item8 = mItems.Where(I => IS["item8"].ToString() == I.ID).First(),
          Item9 = mItems.Where(I => IS["item9"].ToString() == I.ID).First(),
          Item10 = mItems.Where(I => IS["item10"].ToString() == I.ID).First(),
          Item11 = mItems.Where(I => IS["item11"].ToString() == I.ID).First(),
          Item12 = mItems.Where(I => IS["item12"].ToString() == I.ID).First(),
          Item13 = mItems.Where(I => IS["item13"].ToString() == I.ID).First(),
          Item14 = mItems.Where(I => IS["item14"].ToString() == I.ID).First(),
          Item15 = mItems.Where(I => IS["item15"].ToString() == I.ID).First(),
          Item16 = mItems.Where(I => IS["item16"].ToString() == I.ID).First(),
          Item17 = mItems.Where(I => IS["item17"].ToString() == I.ID).First(),
          Item18 = mItems.Where(I => IS["item18"].ToString() == I.ID).First(),
          Item19 = mItems.Where(I => IS["item19"].ToString() == I.ID).First(),
          Item20 = mItems.Where(I => IS["item20"].ToString() == I.ID).First(),
          Item21 = mItems.Where(I => IS["item21"].ToString() == I.ID).First(),
          Item22 = mItems.Where(I => IS["item22"].ToString() == I.ID).First(),
          Item23 = mItems.Where(I => IS["item23"].ToString() == I.ID).First(),
          Item24 = mItems.Where(I => IS["item24"].ToString() == I.ID).First()
        }).ToList();
      }
    }
